...
<div class="products">
   ...
   ?>
      <form method="post" class="box" action="">
         ...
         <div class="price"><span>&#8377</span><?php echo $fetch_product['price']; ?>/-</div>
   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td><span>&#8377</span><?php echo $fetch_cart['price']; ?>/-</td>
            <td>
            ...
            <td><span>&#8377</span><?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</td>
      ...
      <tr class="table-bottom">
         ...
         <td><span>&#8377</span><?php echo $grand_total; ?>/-</td>
